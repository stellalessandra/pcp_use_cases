...
# np.save('../ASSET_fMRI/imat.npy', imat)
# np.save('../ASSET_fMRI/xedges.npy', xedges)
# np.save('../ASSET_fMRI/yedges.npy', yedges)

imat = np.load('../ASSET_fMRI/imat.npy')
xedges = np.load('../ASSET_fMRI/xedges.npy')
yedges = np.load('../ASSET_fMRI/yedges.npy')

# pmat, xedges, yedges = asset.probability_matrix_analytical(spiketrains=sts,
#                                                            binsize=binsize,
#                                                            dt=dt,
#                                                            kernel_width=1*pq.s)
# np.save('../ASSET_fMRI/pmat.npy', pmat)
pmat = np.load('../ASSET_fMRI/pmat.npy')
...
# np.save('../ASSET_fMRI/jmat.npy', jmat)
jmat = np.load('../ASSET_fMRI/jmat.npy')
...
np.save('../ASSET_fMRI/mask.npy', jmat)
jmat = np.load('../ASSET_fMRI/mask.npy')
